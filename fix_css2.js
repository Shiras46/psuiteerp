...
// More flexible pattern: match from .sol-macbook-track down to .sol-macbook-frame img block
const targetPattern = /\.sol-macbook-track {[\s\S]*?\.sol-macbook-frame img {[^}]*}/;

const replacement = `.sol-macbook-track {
